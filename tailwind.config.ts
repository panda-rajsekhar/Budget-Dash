		...
		extend: {
			colors: {
				...
				expense: {
					...
					roomrent: 'hsl(var(--expense-roomrent))',
			...
			backgroundImage: {
				...
				'gradient-transport': 'var(--gradient-transport)',
				'gradient-utilities': 'var(--gradient-utilities)',
				...
				'gradient-roomrent': 'var(--gradient-roomrent)',
